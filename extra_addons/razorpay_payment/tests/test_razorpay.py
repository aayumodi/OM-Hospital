...
# fawekod689@slvlog.com
# Admin1admin


# create razorpay key_api and key_Secret from razorpay app.
# put this api and secret in payment payment_acquirer
# and update the server and payment
# transaction will show in razorpay app transaction