...
###################################################################################
{
    ...
    'depends': ['hr', 'hr_timesheet', 'hr_payroll_community','hr_timesheet_attendance','hr_holidays','hr_holidays_attendance',
                'hr_recruitment', 'event', 'hr_reward_warning','base','web'],
