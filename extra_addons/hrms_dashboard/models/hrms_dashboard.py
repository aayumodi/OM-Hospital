...
class Employee(models.Model):
    ...
    def print_report(self, report_type):
        report_name = 'om_hospital.report_patients_details'
    ...
    def get_user_employee_details(self):
        ...
        patient_id = self.env['hospital.patient'].sudo().search_count([])
        doctor_id = self.env['hospital.doctor'].sudo().search_count([])
